...
public class SystemCommentController {
        ...
        if(EmptyUtils.isEmpty(hotelId)){
            ...
            try {
                ...
                if(EmptyUtils.isNotEmpty(itripScoreCommentVO)){
                    ...
                    return DtoUtil.returnFail("获取评分失败","100002");
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public Dto addComment(@RequestBody ItripAddCommentVO itripAddCommentVO, HttpServletRequest request){
        ...
        if(EmptyUtils.isNotEmpty(itripUser)){
           if(EmptyUtils.isNotEmpty(itripAddCommentVO.getOrderId()) || itripAddCommentVO.getOrderId()!=0){
               ...
               if(itripAddCommentVO.getIsHavingImg()==1){
                   ArrayList<ItripImage> list =new ArrayList<ItripImage>();
                   int i=1;
                   ...
                   try {
                       itripCommentService.itriptxAddItripComment(itripComment,(null==list?new ArrayList<ItripImage>():list));
